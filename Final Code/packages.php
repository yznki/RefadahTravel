...
<head>
  ...
  <title>Packages - Refadah Travel & Tourism</title>
...
<body>
  ...
  <div class="websitePage">
    ...
    <div class="content">
      ...
      $sql = "SELECT * FROM package ORDER BY countryName, cityName";
      ...
      <hr class="divider">
        ...
        foreach ($data as $row) { ?>
          <div class="packagecontent">
            <img src="<?php echo $row['imageURL'] ?>" class="packageimage" alt="PackageImage" style="object-fit: cover">
            <div class="packageinfo">
              <div class="packagetitle">
                <h1 class="citytitle"><?php echo $row['cityName'] ?></h1>
                <p class="packagedesc"><?php echo $row['description'] ?></p>
                <p class="packageprice"><?php echo $row['price'] . " JOD"?></p>
              </div>
              <a href=<?php echo "addpackage.php?package=" . $row['packageID'] . "&id=" . $_SESSION['id']; $_SESSION['add'] = 1;?>><div class="packageaddbutton"><button><i class="fa-solid fa-plus"></i></button></div></a>
            </div>
          </div>
          <hr class="divider">
        <?php } ?>
